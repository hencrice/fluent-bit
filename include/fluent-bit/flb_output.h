...
static inline void flb_output_return(int ret, struct flb_thread *th) {
    ...
    fprintf(stderr, "flb_output_return val: %ld\n", val);
    fprintf(stderr, "flb_output_return out_th->id: %d\n", out_th->id);
    ...
    fflush(stderr);
    fprintf(stderr, "flb_output_return task->config->ch_manager: %p\n", task->config->ch_manager);
    fflush(stderr);
...
static inline void flb_output_return_do(int x)
{
    ...
    fprintf(stderr, "flb_output_return_do &flb_thread_key: %p\n", &flb_thread_key);
    fflush(stderr);
